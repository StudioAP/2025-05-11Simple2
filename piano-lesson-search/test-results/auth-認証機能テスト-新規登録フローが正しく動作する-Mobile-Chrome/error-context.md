...
- Name: 認証機能テスト >> 新規登録フローが正しく動作する
- Location: /Users/akipinnote/Downloads/2025-05-11Simplesearch/piano-lesson-search/e2e/auth.spec.ts:11:7

# Error details

```
Error: locator.fill: Error: strict mode violation: getByLabel('パスワード') resolved to 2 elements:
...
Call log:
  - waiting for getByLabel('パスワード')
    ...
    at /Users/akipinnote/Downloads/2025-05-11Simplesearch/piano-lesson-search/e2e/auth.spec.ts:18:36
```
...
- main:
  ...
  - textbox "お名前": テストユーザー
  - text: メールアドレス
  - textbox "メールアドレス": test-1746948260554@example.com
  - text: パスワード
  - textbox "パスワード"
  - text: パスワード（確認）
  - textbox "パスワード（確認）"
