...
- Name: 基本ナビゲーションテスト >> フッターのリンクが正しく動作する
- Location: /Users/akipinnote/Downloads/2025-05-11Simplesearch/piano-lesson-search/e2e/navigation.spec.ts:82:7
...
Locator: locator('footer').getByRole('link', { name: 'ログイン' })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('footer').getByRole('link', { name: 'ログイン' })

    at /Users/akipinnote/Downloads/2025-05-11Simplesearch/piano-lesson-search/e2e/navigation.spec.ts:91:29
```
